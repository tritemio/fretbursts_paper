...
The function \verb|burst_search_and_gate| accepts the additional arguments
\verb|ph_sel1| and \verb|ph_sel2| used to specify different photon streams. 
However, since their default values correspond to a classical DCBS (see 
section~\ref{sec:burstsearch_intro}), they can be normally omitted 
(like in the previous example), unless one wants to specify different
photon streams.
