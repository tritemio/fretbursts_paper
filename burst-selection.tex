...
for example to select a region on the E-S ALEX histogram (\verb|select_bursts.ES|), 
...
Finally note that different criteria can be combined by applying them in sequence. 
