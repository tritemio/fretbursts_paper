...
\href{http://fretbursts.readthedocs.org/en/latest/data_class.html#burst-selection-methods}{\texttt{select_bursts()} method}
requires as first argument a function implementing the "selection criterion"; all the 
remaining \verb|select_bursts()| arguments are passed to the selection function (\verb|select_bursts.size| in this example). The
