...
\end{lstlisting}
%why is the parameter called th1?
...
% a couple means 2. I suppose that's what you mean?
...
dsw = ds.select_bursts(select_bursts.width,
                       th1=0.5e-3, th2=3e-3)
\end{lstlisting}
%I guess this answers my question about the meaning of th1. Maybe it would be worth to spell it out above?
