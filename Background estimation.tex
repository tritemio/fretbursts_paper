...
As noted in section~\ref{sec:bg_intro}, estimating the background rate involves estimating the rate of a Poisson process.

To compute the background every 30s, using a threshold of 2 ms for all the photon streams we execute:
