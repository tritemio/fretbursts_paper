...
Broad FRET distribution as a result of molecular dynamics can be determined through BVA analysis. BVA analysis consists of three steps: slicing a bursts into sub-bursts comprised of \textit{n} consecutive photons, computing FRET efficiencies of sub-bursts and standard deviation ($s_E$) from a mean FRET efficiency for the burst, comparing $s_E$ to an expected standard deviation based on shot noise limited distribution~\cite{Torella_2011}. 
