...
Note that photon time stamp arrays by \verb|Data.mburst| are based upon ALEX (alternating laser excitation by two lasers) while BVA is based upon a single laser excitation.
