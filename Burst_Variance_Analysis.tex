...
iterate through bursts, while the inner loop iterates through sub-bursts in each burst.
The variables \verb|startlist| and \verb|stoplist| contains start-stop indexes for
