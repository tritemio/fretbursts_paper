...
$E$ is the FRET efficiency. (In practice, Proximity ratio is used as $E$ instead of FRET efficiency) This is an approximation because background counts (both from sample and detector's dark counts) add additional variance that is not taken into account.
