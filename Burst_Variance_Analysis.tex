...
Note that photon time stamp arrays by \verb|Data.mburst| are based on ALEX (alternating laser excitation by two lasers) while BVA is based on a single laser excitation.
