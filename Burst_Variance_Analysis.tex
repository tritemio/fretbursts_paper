...
BVA analysis consists of three steps: 1) slicing a bursts into sub-bursts comprised of \textit{n} consecutive photons, 2) computing FRET efficiencies of each sub-burst and calculating a standard deviation ($s_E$) of these FRET efficiencies for sub-bursts from a mean FRET efficiency for the whole burst, and 3) comparing $s_E$ to an expected standard deviation based on shot noise limited distribution~\cite{Torella_2011}. 
