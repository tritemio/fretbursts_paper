...
BVA analysis consists of three steps: slicing a bursts into sub-bursts comprised of \textit{n} consecutive photons, computing FRET efficiencies of each sub-burst and calculating a standard deviation ($s_E$) of these FRET efficiencies for sub-bursts from a mean FRET efficiency for the whole burst, comparing $s_E$ to an expected standard deviation based on shot noise limited distribution~\cite{Torella_2011}. 
