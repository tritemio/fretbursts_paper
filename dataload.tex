...
In µs-ALEX measurements, CW lasers are alternated in the timescale of 10~µs.
...
In ns-ALEX measurements, pulsed lasers are interleaved with typical separation of 10-20~ns.
...
will plots the relevant alternation histogram using currently selected 
donor and acceptor excitation periods (or default values).

In figure~\ref{fig:altern_hist_double}, donor and acceptor excitation periods 
are represented by light green and red shaded areas respectively.
...
will be present in \verb|d|. At this point, in order to further change the period definitions,
