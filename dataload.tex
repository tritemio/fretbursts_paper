...
will be present in \verb|d|, therefore to apply a new alternation period 
it is necessary to reload the file.

For ns-ALEX measurements the exact same functions and syntax is used.
This time, however, the plot function will show a nanotime histogram and 
the period ranges will be expressed in nanotime units instead of 
timestamp units.
