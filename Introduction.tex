...
To assure the correctness of the results, FRETBursts is developed using modern 
...
optimized with \href{http://cython.org/}{cython} and the software is preferentially run through
a \href{http://ipython.org/}{Jupyter (IPython) Notebook} (optional).
