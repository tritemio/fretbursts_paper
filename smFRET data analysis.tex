...
On MS Windows, it is good practice to use \href{RAW strings}{https://docs.python.org/2/tutorial/introduction.html#strings} for file names (for example: \verb|r'C:\Data\smFRET\example.hdf5'|, note the prepending \textit{r}) in order to avoid substitutions of special escape sequences like '\t' (that would be replaced with TAB in a normal string).
