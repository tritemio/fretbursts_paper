...
In this way we can skip the \verb|fb.| prefix. Note that the previous import also imports common numeric libraries (numpy, pandas, matplotlib.pyplot as \verb|np|, \verb|pd| and \verb|plt| respectively).
