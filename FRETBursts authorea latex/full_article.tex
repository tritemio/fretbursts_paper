...
\begin{flushleft}
{\Large
\textbf\newline{FRETBursts: An Open Source Toolkit for Analysis of Freely-Diffusing Single-Molecule FRET}
}
\newline
...
,
 Eitan Lerner\textsuperscript{2},
 SangYoon Chung\textsuperscript{3},
 Shimon Weiss\textsuperscript{4},
 X. Michalet\textsuperscript{5}
...
{\bf 3} Affiliation not available
\\

{\bf 4} Affiliation not available
\\

{\bf 5} Affiliation not available
\\
...
with either CW lasers (\selectlanguage{greek}μ\selectlanguage{english}s-ALEX~\cite{Kapanidis_2005})
...
\selectlanguage{greek}\caption{\label{fig:bg_timetrace} \textbf{Background rates as a function of time.}
...
FRETBursts also supports loading \selectlanguage{greek}μ\selectlanguage{english}s-ALEX data stored in .sm files
...
For \selectlanguage{greek}μ\selectlanguage{english}s-ALEX and ns-ALEX data, Photon-HDF5 normally stores parameters defining
...
In \selectlanguage{greek}μ\selectlanguage{english}s-ALEX measurements~\cite{Kapanidis_2004},
CW laser lines are alternated on timescales of the order of 10 to 100~\selectlanguage{greek}μ\selectlanguage{english}s.
...
\selectlanguage{greek}\caption{\label{fig:altern_hist_double} 
...
The previous command works for both \selectlanguage{greek}μ\selectlanguage{english}s-ALEX and ns-ALEX measurements.
...
\textit{Background estimation} section of the \selectlanguage{greek}μ\selectlanguage{english}s-ALEX tutorial 
...
In \selectlanguage{greek}μ\selectlanguage{english}s-ALEX, there are 3 important correction parameters: $\gamma$-factor, 
...
fitting section of the \selectlanguage{greek}μ\selectlanguage{english}s-ALEX notebook (\href{http://nbviewer.jupyter.org/github/tritemio/FRETBursts_notebooks/blob/master/notebooks/FRETBursts%20-%20us-ALEX%20smFRET%20burst%20analysis.ipynb#FRET-fit:-in-depth-example}{link}),
...
the aforementioned \selectlanguage{greek}μ\selectlanguage{english}s-ALEX notebook
...
reported here. The work at UCLA was conducted in Dr. Weiss'\selectlanguage{english}s Laboratory. 
...
between the EDF and the theoretical distribution. The second is the Cram\selectlanguage{ngerman}é\selectlanguage{english}r von Mises
