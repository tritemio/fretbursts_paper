...
in~\ref{sec:notebook}. % SI_link
Detailed information on development style, testing strategies and
contributions guidelines are reported in~\ref{sec:dev}. % SI_link
...
inversely proportional to the burst size (see~\ref{sec:burstweights_theory} for details). % SI_link
...
threshold as described in~\ref{sec:bg_opt_th}. % SI_link
...
as described in~\ref{sec:plotting}. % SI_link
...
FRETBursts is an open source and openly developed (see~\ref{sec:dev}) implementation % SI_link
