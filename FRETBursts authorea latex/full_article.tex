...
by leveraging the functions in FRETBursts
and the standard scientific Python libraries. 
To this end, in the next section, we show how to perform low-level 
analysis of timestamps and bursts data by implementing the BVA
method from scratch.
...
We encourage researchers implementing new methods with FRETBursts 
to share their work and to integrate it in FRETBursts in order 
