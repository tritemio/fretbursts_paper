...
Information regarding FRETBursts execution using Jupyter notebooks can be found in SI~\ref{sec:notebook}.
Detailed information on developemnt style, tesing strategies and contributions are
reported in SI~\ref{sec:dev}.