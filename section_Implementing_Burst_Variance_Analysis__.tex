...
If the broadness originates from different molecules with static but different FRET efficiencies, $s_E$ of each burst are only affected by shot noise and will follow a binomial distribution.  
