...
If the broadness originates from different molecules with static but different FRET efficiencies, $s_E$ of each burst is only affected by shot noise and will follow a binomial distribution. However, if the broadness is from dynamics of single biomolecules, $s_E$ of each burst has to be larger than $\sigma_E$.  
