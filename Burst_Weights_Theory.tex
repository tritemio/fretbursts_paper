...
the PR estimator to the FRET distribution plot. Building an
...
To illustrate the results of previous section we performed two kinds of simulations.

In the first, is a simple verification of the results of previous section, namely
...
distribution that is optimal (in the sense of not discarding information) while removing
