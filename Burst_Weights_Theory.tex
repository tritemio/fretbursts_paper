...
numerically-computed (non-Gaussian PSF). Input parameters includes
...
PyBroMo~\cite{Ingargiola_2016} which creates smFRET data files (i.e. timestamps and detectors
