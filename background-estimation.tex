...
Here, the first argument (\verb|bg.exp_fit|) is the actual fitting function used to fit the
...
is the timestamp delay threshold above which the distribution is exponential. 
